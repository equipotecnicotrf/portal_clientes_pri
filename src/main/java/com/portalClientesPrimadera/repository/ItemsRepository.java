...
public interface ItemsRepository extends JpaRepository <ItemsEntity,Long>{
    ...
    @Query("SELECT DISTINCT i.Atribute1 FROM ItemsEntity i WHERE i.Atribute1 <> 'N/A'")
    public List<String> findDistinctAttribute1();

    @Query("SELECT DISTINCT i.Atribute2 FROM ItemsEntity i WHERE i.Atribute2 <> 'N/A'")
    public List<String> findDistinctAttribute2();

    @Query("SELECT DISTINCT i.Atribute3 FROM ItemsEntity i WHERE i.Atribute2 <> '0'")
    public List<String> findDistinctAttribute3();

    @Query("SELECT DISTINCT i.Atribute4 FROM ItemsEntity i WHERE i.Atribute4 <> 'N/A'")
    public List<String> findDistinctAttribute4();

    @Query("SELECT DISTINCT i.Atribute5 FROM ItemsEntity i WHERE i.Atribute5 <> 'N/A'")
    public List<String> findDistinctAttribute5();

    @Query("SELECT DISTINCT i.Atribute6 FROM ItemsEntity i WHERE i.Atribute5 <> '0'")
    public List<Integer> findDistinctAttribute6();

    @Query("SELECT DISTINCT i.Atribute7 FROM ItemsEntity i WHERE i.Atribute7 <> 'N/A'")
